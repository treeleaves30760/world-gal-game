...
```yaml
"affection:qingyi=5"          # = {kind: affection, target: qingyi, value: 5}
"set_flag:met_qingyi"         # = {kind: set_flag, target: met_qingyi}
```
...
```yaml
- {kind: affection, target: qingyi, value: 5}                  # +5 affection
- {kind: affection, target: qingyi, value: -3, stat: trust}    # -3 trust
```
...
```yaml
- {kind: stat, target: qingyi, value: 8, stat: fear}
```
...
```yaml
- {kind: set_flag, target: orientation_done}                   # = true
...
```yaml
- {kind: move_to, target: library_stacks}
```
...
```yaml
- {kind: gift, target: qingyi, stat: jasmine_tea}
```
